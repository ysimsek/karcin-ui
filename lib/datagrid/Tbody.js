...
var Tbody = /** @class */ (function (_super) {
    ...
    Tbody.prototype.render = function () {
        var getData = this.getData(), rows = getData[0], context = getData[1];
        ...
        if (data !== undefined && data.length > 0) {
            data.forEach(function (value, index) {
                ...
                _this.state.fields.forEach(function (values, indexes) {
                    ...
                    Cell.push(React.createElement("td", { key: indexes, style: style, id: ('row' + index) }, (values.renderer !== undefined) ? values.renderer(value, values) !== undefined ? value.renderer(value, values) : fieldValData : fieldValData));
                });
