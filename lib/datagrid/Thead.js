        ...
        if (data !== undefined) {
            ...
            if (Array.isArray(data)) {
                data.forEach(function (value, indexes) {
                    ...
                    returnItem.push(React.createElement("th", { key: indexes, className: "" + (_this.state.orderIng.name !== null && value.name === _this.state.orderIng.name || _this.state.filterShowing[value.name] ? 'active' : ''), style: style, ref: function (e) { return itemRef_1 = e; } },
            ...
            this.state.fields.forEach(function (values, index) {
                if (values['visibility'] !== undefined && !values['visibility']) {
                    fieldButtons.push(React.createElement(reactstrap_1.DropdownItem, { onClick: function () {
                        ...
                        React.createElement(reactstrap_1.Input, { type: "checkbox", defaultChecked: false }),
                        values.label));
                }
                else {
                    fieldButtons.push(React.createElement(reactstrap_1.DropdownItem, { onClick: function (e) {
                            _this.fieldShowing(index);
                        } },
                        React.createElement(reactstrap_1.Input, { type: "checkbox", defaultChecked: true }),
                        values.label));
                }
            });
        }
    ...
    Thead.prototype.getFilter = function (data) {
        ...
        filterContent = React.createElement(reactstrap_1.ButtonDropdown, { isOpen: (this.state.filterShowing[data.name] !== undefined && this.state.filterShowing[data.name]) ? this.state.filterShowing[data.name] : false, toggle: function () { _this.filterToggle(data); } },
            ...
            React.createElement(reactstrap_1.DropdownMenu, null,
                React.createElement(GetInput_1.default, { type: data.type, value: this.state.filterOption.value, onChange: function (e) {
