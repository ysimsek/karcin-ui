...
export default class AjaxRequest {
    ...
    callAjax(props: Object) {
        axios(props).then((response) => {
            // props success control
            if(this.props['success'] !== null) { this.props['success'](response); }

            // props error callback function
            if(this.props['callback'] !== null) { this.props['callback'](response); }

        }).catch((error) => {
            // props error control
            if(this.props['error'] !== null) { this.props['error'](error); }

            // props error callback function
            if(this.props['callback'] !== null) { this.props['callback'](error); }
        });
