AmCharts.translations["export"] || (AmCharts.translations["export"] = {}), AmCharts.translations["export"].en || (AmCharts.translations["export"].en = { "fallback.save.text": "CTRL + C to copy the data into the clipboard.", "fallback.save.image": "Rightclick -> Save picture as... to save the image.", "capturing.delayed.menu.label": "{{duration}}", "capturing.delayed.menu.title": "Click to cancel", "menu.label.print": "Print", "menu.label.undo": "Undo", "menu.label.redo": "Redo", "menu.label.cancel": "Cancel", "menu.label.save.image": "Download as ...", "menu.label.save.data": "Save as ...", "menu.label.draw": "Annotate ...", "menu.label.draw.change": "Change ...", "menu.label.draw.add": "Add ...", "menu.label.draw.shapes": "Shape ...", "menu.label.draw.colors": "Color ...", "menu.label.draw.widths": "Size ...", "menu.label.draw.opacities": "Opacity ...", "menu.label.draw.text": "Text", "menu.label.draw.modes": "Mode ...", "menu.label.draw.modes.pencil": "Pencil", "menu.label.draw.modes.line": "Line", "menu.label.draw.modes.arrow": "Arrow", "label.saved.from": "Saved from: " }), function () { AmCharts["export"] = function (t, r) { var s, d = { name: "export", version: "1.4.76", libs: { async: !0, autoLoad: !0, reload: !1, resources: ["fabric.js/fabric.min.js", "FileSaver.js/FileSaver.min.js", { "jszip/jszip.min.js": ["xlsx/xlsx.min.js"], "pdfmake/pdfmake.min.js": ["pdfmake/vfs_fonts.js"] }], namespaces: { "pdfmake.min.js": "pdfMake", "jszip.min.js": "JSZip", "xlsx.min.js": "XLSX", "fabric.min.js": "fabric", "FileSaver.min.js": "saveAs" }, loadTimeout: 1e4, unsupportedIE9libs: ["pdfmake.min.js", "jszip.min.js", "xlsx.min.js"] }, config: {}, setup: { chart: t, hasBlob: !1, wrapper: !1, isIE: !!window.document.documentMode, IEversion: window.document.documentMode, hasTouch: "object" == typeof window.Touch, focusedMenuItem: void 0, hasClasslist: "classList" in document.createElement("_") }, drawing: { enabled: !1, undos: [], redos: [], buffer: { position: { x1: 0, y1: 0, x2: 0, y2: 0, xD: 0, yD: 0 } }, handler: { undo: function () { var c = d.drawing.undos.pop(); if (c) {
                if (c.selectable = !0, d.drawing.redos.push(c), "added" == c.action)
                    ...
                    c.target.recentState = c.state, c.target instanceof fabric.Group ? (u = d.prepareGroupState(u), c.target.set(u), d.drawing.handler.change({ color: u.cfg.color, width: u.cfg.width, opacity: u.cfg.opacity }, !0, c.target)) : c.target.set(u);
                }
                d.setup.fabric.renderAll();
            } }, redo: function () { var c = d.drawing.redos.pop(); if (c) {
                ...
                var u = JSON.parse(c.state);
                c.target.recentState = c.state, c.target instanceof fabric.Group ? (u = d.prepareGroupState(u), c.target.set(u), d.drawing.handler.change({ color: u.cfg.color, width: u.cfg.width, opacity: u.cfg.opacity }, !0, c.target)) : c.target.set(u), d.setup.fabric.renderAll();
                ...
                for (m = JSON.parse(S.recentState).cfg, m && (h.color = h.color || m.color, h.width = h.width || m.width, h.opacity = h.opacity || m.opacity, h.fontSize = h.fontSize || m.fontSize, N = d.getRGBA(h.color), N.pop(), N.push(h.opacity), h.color = "rgba(" + N.join() + ")"), S.changed = !0, w = 0; w < T.length; w++)
                    T[w] instanceof fabric.Text || T[w] instanceof fabric.PathGroup || T[w] instanceof fabric.Triangle ? ((h.color || h.opacity) && T[w].set({ fill: h.color }), h.fontSize && T[w].set({ fontSize: h.fontSize })) : (T[w] instanceof fabric.Path || T[w] instanceof fabric.Line) && (S instanceof fabric.Group ? (h.color || h.opacity) && T[w].set({ stroke: h.color }) : ((h.color || h.opacity) && T[w].set({ stroke: h.color }), h.width && T[w].set({ strokeWidth: h.width })));
                u || (m = JSON.stringify(d.deepMerge(d.getState(S), { cfg: { color: h.color, width: h.width, opacity: h.opacity } })), S.recentState = m, d.drawing.redos = [], d.drawing.undos.push({ action: "modified", target: S, state: m })), d.setup.fabric.renderAll();
        ...
        throw new Error("Unable to create file. Ensure saveAs (FileSaver.js) is supported."); return c; }, loadResource: function (c, u) { function f() { d.handleLog(["amCharts[export]: Loading error on ", this.src || this.href].join("")); } function h() { if (u)
        for (m = 0; m < u.length; m++)
            d.loadResource(u[m]); } var m, w, N, S, T, A, M = -1 == c.indexOf("//") ? [d.libs.path, c].join("") : c; for (-1 == c.indexOf(".js") ? -1 != c.indexOf(".css") && (N = document.createElement("link"), N.setAttribute("type", "text/css"), N.setAttribute("rel", "stylesheet"), N.setAttribute("href", M)) : (N = document.createElement("script"), N.setAttribute("type", "text/javascript"), N.setAttribute("src", M), d.libs.async && N.setAttribute("async", "")), m = 0; m < document.head.childNodes.length; m++)
        ...
        if ("clipPath" == w.tagName) {
            ...
            f.included++, fabric.Image.fromURL(w.getAttribute("xlink:href"), function () { f.loaded++; });
        else {
            var A = ["fill", "stroke"];
    ...
    } }, fabric.Text.fromElement = function (c, u) { if (!c)
        return null; var f = fabric.parseAttributes(c, fabric.Text.ATTRIBUTE_NAMES); u = fabric.util.object.extend(u ? fabric.util.object.clone(u) : {}, f), u.top = u.top || 0, u.left = u.left || 0, "dx" in f && (u.left += f.dx), "dy" in f && (u.top += f.dy), "fontSize" in u || (u.fontSize = fabric.Text.DEFAULT_SVG_FONT_SIZE), u.originX || (u.originX = "left"); var h = "", m = []; if (!("textContent" in c))
        "firstChild" in c && null !== c.firstChild && "data" in c.firstChild && null !== c.firstChild.data && m.push(c.firstChild.data);
    else if (c.childNodes)
        for (var w = 0; w < c.childNodes.length; w++)
            m.push(c.childNodes[w].textContent);
    else
        m.push(c.textContent); h = m.join("\n"); var N = new fabric.Text(h, u), S = 0; return "left" === N.originX && (S = N.getWidth() / 2), "right" === N.originX && (S = -N.getWidth() / 2), 1 < m.length ? N.set({ left: N.getLeft() + S, top: N.getTop() + N.fontSize * (m.length - 1) * (0.18 + N._fontSizeFraction), textAlign: u.originX, lineHeight: 1 < m.length ? 0.965 : 1.16 }) : N.set({ left: N.getLeft() + S, top: N.getTop() - N.getHeight() / 2 + N.fontSize * (0.18 + N._fontSizeFraction) }), N; }; }, capture: function (c, u) { var f, h = d.deepMerge(d.deepMerge({}, d.config.fabric), c || {}), m = [], w = { x: 0, y: 0, pX: 0, pY: 0, lX: 0, lY: 0, width: d.setup.chart.divRealWidth, height: d.setup.chart.divRealHeight }, N = { loaded: 0, included: 0 }, S = { items: [], width: 0, height: 0, maxWidth: 0, maxHeight: 0 }; if (!d.handleNamespace("fabric", { scope: this, cb: d.capture, args: arguments }))
        return !1; d.modifyFabric(), d.handleCallback(h.beforeCapture, h); var T = d.setup.chart.containerDiv.getElementsByTagName("svg"); for (f = 0; f < T.length; f++) {
        var A = { svg: T[f], parent: T[f].parentNode, children: T[f].getElementsByTagName("*"), offset: { x: 0, y: 0 }, patterns: {}, clippings: {}, has: { legend: !1, panel: !1, scrollbar: !1 } };
        ...
        "stock" == d.setup.chart.type && d.setup.chart.legendSettings.position ? -1 == ["top", "bottom"].indexOf(d.setup.chart.legendSettings.position) ? -1 != ["left", "right"].indexOf(d.setup.chart.legendSettings.position) && (A.offset.y = d.pxToNumber(A.parent.style.top) + w.pY, A.offset.x = d.pxToNumber(A.parent.style.left) + w.pX, A.has.legend ? w.pY += d.pxToNumber(A.has.panel.style.height) + d.setup.chart.panelsSettings.panelSpacing : A.has.scrollbar && (A.offset.y -= d.setup.chart.panelsSettings.panelSpacing)) : A.parent.style.top && A.parent.style.left ? (A.offset.y = d.pxToNumber(A.parent.style.top), A.offset.x = d.pxToNumber(A.parent.style.left)) : (A.offset.x = w.x, A.offset.y = w.y, w.y += d.pxToNumber(A.parent.style.height), A.has.panel ? (w.pY = d.pxToNumber(A.has.panel.style.marginTop), A.offset.y += w.pY) : A.has.scrollbar && (A.offset.y += w.pY)) : ("absolute" == A.parent.style.position ? (A.offset.absolute = !0, A.offset.top = d.pxToNumber(A.parent.style.top), A.offset.right = d.pxToNumber(A.parent.style.right, !0), A.offset.bottom = d.pxToNumber(A.parent.style.bottom, !0), A.offset.left = d.pxToNumber(A.parent.style.left), A.offset.width = d.pxToNumber(A.parent.style.width), A.offset.height = d.pxToNumber(A.parent.style.height)) : A.parent.style.top && A.parent.style.left ? (A.offset.y = d.pxToNumber(A.parent.style.top), A.offset.x = d.pxToNumber(A.parent.style.left)) : A.legend ? ("left" == A.legend.position ? w.x = S.maxWidth : "right" == A.legend.position ? A.offset.x = w.width - S.maxWidth : "top" == A.legend.position ? w.y += A.legend.height : "bottom" == A.legend.position && (A.offset.y = w.height - S.height), A.offset.y += w.lY, w.lY += A.legend.height) : (A.offset.x = w.x, A.offset.y = w.y + w.pY, w.y += d.pxToNumber(A.parent.style.height)), A.has.legend && A.has.panel && A.has.panel.style.marginTop ? (w.y += d.pxToNumber(A.has.panel.style.marginTop), A.offset.y += d.pxToNumber(A.has.panel.style.marginTop)) : d.setup.chart.legend && -1 != ["left", "right"].indexOf(d.setup.chart.legend.position) && (A.offset.y = d.pxToNumber(A.parent.style.top), A.offset.x = d.pxToNumber(A.parent.style.left))), fabric.parseSVGDocument(A.svg, function (E) { return function (I, P) { var O, G = fabric.util.groupSVGElements(I, P), z = [], U = { selectable: !1, isCoreElement: !0 }; for (E.offset.absolute ? (U.top = void 0 === E.offset.bottom ? E.offset.top : w.height - E.offset.height - E.offset.bottom, U.left = void 0 === E.offset.right ? E.offset.left : w.width - E.offset.width - E.offset.right) : (U.top = E.offset.y, U.left = E.offset.x), O = 0; O < G.paths.length; O++) {
            ...
            "/>" != H && (U = 3, H = T.slice(-U));
            var X = T.slice(0, T.length - U), W = " clip-path=\"url(#" + z + ")\" ", _ = d.gatherAttribute(A.svg, "class");
        ...
        } return T; } }, c || {}); if (!d.handleNamespace("fabric", { scope: this, cb: d.toSVG, args: arguments }))
        return !1; if (w = d.setup.fabric.toSVG(m, m.reviver), f.length) {
        var N = w.slice(0, w.length - 6), S = w.slice(-6);
        w = N + f.join("") + S;
    } return m.compress && (w = w.replace(/[\t\r\n]+/g, "")), m.getBase64 && (w = "data:image/svg+xml;base64," + btoa(w)), d.handleCallback(u, w, m), w; }, toPDF: function (c, u) { function f(A) { if ("number" == typeof A || A instanceof Number)
        A = { left: A, right: A, top: A, bottom: A };
    else if (!(A instanceof Array))
        A = { left: d.defaults.pdfMake.pageMargins, top: d.defaults.pdfMake.pageMargins, right: d.defaults.pdfMake.pageMargins, bottom: d.defaults.pdfMake.pageMargins };
    else if (2 === A.length)
        A = { left: A[0], top: A[1], right: A[0], bottom: A[1] };
    else if (4 === A.length)
        A = { left: A[0], top: A[1], right: A[2], bottom: A[3] };
    else
        throw "Invalid pageMargins definition"; return A; } function h(A, M) { var F = d.defaults.pdfMake.pageSizes[(A + "").toUpperCase()].slice(); if (!F)
        throw new Error("The given pageSize \"" + A + "\" does not exist!"); return "landscape" == M && F.reverse(), F; } var w, m = d.deepMerge(d.deepMerge({ multiplier: d.config.multiplier || 2, pageOrigin: void 0 === d.config.pageOrigin }, d.config.pdfMake), c || {}, !0); if (/iP(hone|od|ad)/.test(navigator.platform) && (m.multiplier = 1), !d.handleNamespace("pdfMake", { scope: this, cb: d.toPDF, args: arguments }))
        return !1; if (m.images.reference = d.toPNG(m), !m.content) {
        var N = [], S = h(m.pageSize, m.pageOrientation), T = f(m.pageMargins);
        S[0] -= T.left + T.right, S[1] -= T.top + T.bottom, m.pageOrigin && (N.push(d.i18l("label.saved.from")), N.push(window.location.href), S[1] -= 2 * 14.064), N.push({ image: "reference", fit: S }), m.content = N;
    } return w = new pdfMake.createPdf(m), u && w.getDataUrl(function (A) { return function () { A.apply(d, arguments); }; }(u)), w; }, toPRINT: function (c, u) { var f, h = d.deepMerge({ delay: 1, lossless: !1 }, c || {}), m = d.toImage(h), w = [], N = document.body.childNodes, S = document.documentElement.scrollTop || document.body.scrollTop; for (m.setAttribute("style", "width: 100%; max-height: 100%;"), f = 0; f < N.length; f++)
        d.isElement(N[f]) && (w[f] = N[f].style.display, N[f].style.display = "none"); document.body.appendChild(m), h.delay *= 1e3; var T = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream; return T && 1e3 > h.delay && (h.delay = 1e3), setTimeout(function () { window.print(), setTimeout(function () { for (f = 0; f < N.length; f++)
        d.isElement(N[f]) && (N[f].style.display = w[f]); document.body.removeChild(m), document.documentElement.scrollTop = document.body.scrollTop = S, d.handleCallback(u, m, h); }, h.delay); }, h.delay), m; }, toJSON: function (c, u) { var f = d.deepMerge({ dateFormat: d.config.dateFormat || "dateObject" }, c || {}, !0), h = {}; return !!d.handleNamespace("JSON", { scope: this, cb: d.toJSON, args: arguments }) && (f.data = void 0 === f.data ? d.getChartData(f) : f.data, h = JSON.stringify(f.data, void 0, "\t"), d.handleCallback(u, h, f), h); }, toCSV: function (c, u) { var m = d.deepMerge({ delimiter: ",", quotes: !0, escape: !0, withHeader: !0 }, c || {}, !0), w = [], N = ""; return w = d.toArray(m), Object.keys(w).some(function (S) { isNaN(S) || (N += w[S].join(m.delimiter) + "\n"); }), d.handleCallback(u, N, m), N; }, toXLSX: function (c, u) { function f(T, A) { A && (T += 1462); var M = Date.parse(T), F = 1e3 * (60 * T.getTimezoneOffset()); return (M - F - new Date(Date.UTC(1899, 11, 30))) / 86400000; } var m = d.deepMerge({ name: "amCharts", dateFormat: d.config.dateFormat || "dateObject", withHeader: !0, stringify: !1 }, c || {}, !0), w = [], N = "", S = { SheetNames: [], Sheets: {} }; return !!d.handleNamespace("XLSX", { scope: this, cb: d.toXLSX, args: arguments }) && (w = d.toArray(m), S.SheetNames.push(m.name), S.Sheets[m.name] = function (T) { for (var M = {}, F = { s: { c: 1e7, r: 1e7 }, e: { c: 0, r: 0 } }, D = 0; D != T.length; ++D)
        ...
        } return 1e7 > F.s.c && (M["!ref"] = XLSX.utils.encode_range(F)), M; }(w), N = XLSX.write(S, { bookType: "xlsx", bookSST: !0, type: "base64" }), N = "data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64," + N, d.handleCallback(u, N, m), N); }, toArray: function (c, u) { function h(F) { return "string" == typeof F && (N.escape && (F = F.replace("\"", "\"\"")), N.quotes && (F = ["\"", F, "\""].join(""))), F; } var w, N = d.deepMerge({ withHeader: !1, stringify: !0, escape: !1, quotes: !1 }, c || {}, !0), S = [], T = [], A = [], M = d.config.processData; return N.processData = function (F, D) { var E = D.exportFields || Object.keys(D.dataFieldsMap); for (w = 0; w < E.length; w++) {
        var I = E[w], P = D.dataFieldsTitlesMap[I];
        T.push(P);
    } return M ? d.handleCallback(M, F, D) : F; }, N.data = void 0 === N.data ? d.getChartData(N) : d.processData(N), N.withHeader && (A = [], Object.keys(T).some(function (F) { isNaN(F) || A.push(h(T[F])); }), S.push(A)), Object.keys(N.data).some(function (F) { A = [], isNaN(F) || (Object.keys(T).some(function (D) { if (!isNaN(D)) {
        var D = T[D], E = N.data[F][D];
        E = null == E ? "" : N.stringify ? E + "" : E, A.push(h(E));
    } }), S.push(A)); }), d.handleCallback(u, S, N), S; }, toByteArray: function (c, u) { function f(D) { var E = D.charCodeAt(0); return E === N ? 62 : E === S ? 63 : E < T ? -1 : E < T + 10 ? E - T + 26 + 26 : E < M + 26 ? E - M : E < A + 26 ? E - A + 26 : void 0; } var m = d.deepMerge({}, c || {}), w = "undefined" == typeof Uint8Array ? Array : Uint8Array, N = "+".charCodeAt(0), S = "/".charCodeAt(0), T = "0".charCodeAt(0), A = "a".charCodeAt(0), M = "A".charCodeAt(0), F = function (D) { function E(X) { z[H++] = X; } var I, P, O, B, G, z; if (0 < D.length % 4)
        throw new Error("Invalid string. Length must be a multiple of 4"); var U = D.length; G = "=" === D.charAt(U - 2) ? 2 : "=" === D.charAt(U - 1) ? 1 : 0, z = new w(3 * D.length / 4 - G), O = 0 < G ? D.length - 4 : D.length; var H = 0; for (I = 0, P = 0; I < O; I += 4, P += 3)
        B = f(D.charAt(I)) << 18 | f(D.charAt(I + 1)) << 12 | f(D.charAt(I + 2)) << 6 | f(D.charAt(I + 3)), E((16711680 & B) >> 16), E((65280 & B) >> 8), E(255 & B); return 2 === G ? (B = f(D.charAt(I)) << 2 | f(D.charAt(I + 1)) >> 4, E(255 & B)) : 1 == G && (B = f(D.charAt(I)) << 10 | f(D.charAt(I + 1)) << 4 | f(D.charAt(I + 2)) >> 2, E(255 & B >> 8), E(255 & B)), z; }(m.data); return d.handleCallback(u, F, m), F; }, removeFunctionsFromObject: function (c) { return Object.keys(c).some(function (u) { "function" == typeof c[u] && delete c[u]; }), c; }, handleCallback: function (c) { var u, f = []; if (c && c instanceof Function) {
        for (u = 0; u < arguments.length; u++)
            0 < u && f.push(arguments[u]);
        return c.apply(d, f);
    } }, handleLog: function (c) { !0 === d.config.debug && console.log(c); }, handleNamespace: function (c, u) { function f() { var S = +new Date; m = !!(c in h), "pdfMake" == c && m && (m = h.pdfMake.vfs), m ? (clearTimeout(N), u.cb.apply(u.scope, u.args), d.handleLog(["AmCharts [export]: Namespace \"", c, "\" showed up in: ", h + ""].join(""))) : S - w < d.libs.loadTimeout ? N = setTimeout(f, 250) : d.handleLog(["AmCharts [export]: Gave up waiting for \"", c, "\" in: ", h + ""].join("")); } var N, h = d.config.scope || window, m = !1, w = +new Date; return m = !!(c in h), m || (d.handleLog(["AmCharts [export]: Could not find \"", c, "\" in: ", h + ""].join("")), f()), m; }, handleBorder: function (c) { if (d.config.border instanceof Object) {
    ...
    } }, handleDropbox: function (c) { if (d.drawing.enabled)
        ...
        if ("stock" == d.setup.chart.type) {
            ...
            f.data = d.setup.chart.dataProvider, u(d.setup.chart.titleField), f.dateFields.push(d.setup.chart.titleField), u(d.setup.chart.valueField);
            ...
            } return d.processData(f); }, getAnnotations: function (c, u) { var h, f = d.deepMerge({}, c || {}, !0), m = []; for (h = 0; h < d.setup.fabric._objects.length; h++)
        if (!d.setup.fabric._objects[h].isCoreElement) {
            var w = d.setup.fabric._objects[h].toJSON();
            d.handleCallback(f.reviver, w, h), m.push(w);
        } return d.handleCallback(u, m), m; }, setAnnotations: function (c, u) { var f = d.deepMerge({ data: [] }, c || {}, !0); return fabric.util.enlivenObjects(f.data, function (h) { h.forEach(function (m, w) { d.handleCallback(f.reviver, m, w), d.setup.fabric.add(m); }), d.handleCallback(u, f); }), f.data; }, processData: function (c) { var f, h, u = d.deepMerge({ data: [], titles: {}, dateFields: [], dataFields: [], dataFieldsMap: {}, dataFieldsTitlesMap: {}, dataDateFormat: d.setup.chart.dataDateFormat, dateFormat: d.config.dateFormat || d.setup.chart.dataDateFormat || "YYYY-MM-DD", exportTitles: d.config.exportTitles, exportFields: d.config.exportFields, exportSelection: d.config.exportSelection, columnNames: d.config.columnNames, processData: d.config.processData }, c || {}, !0); if (u.data.length) {
        for (f = 0; f < u.data.length; f++)
            Object.keys(u.data[f]).some(function (F) { -1 == u.dataFields.indexOf(F) && (u.dataFields.push(F), u.dataFieldsMap[F] = F); });
        void 0 !== u.exportFields && (u.dataFields = u.exportFields.filter(function (F) { return -1 != u.dataFields.indexOf(F); }));
        var m = [];
        for (f = 0; f < u.data.length; f++) {
            var w = {}, N = !1;
            for (h = 0; h < u.dataFields.length; h++) {
                var S = u.dataFields[h], T = u.dataFieldsMap[S], A = u.columnNames && u.columnNames[S] || u.titles[S] || S, M = u.data[f][T];
        ...
        u.data = m;
    } return void 0 !== u.processData && (u.data = d.handleCallback(u.processData, u.data, u)), u.data; }, capitalize: function (c) { return c.charAt(0).toUpperCase() + c.slice(1).toLowerCase(); }, createMenu: function (c, u) { function f(w, N) { var S, T, A = document.createElement("ul"); for (S = 0; S < w.length; S++) {
        var M = "string" == typeof w[S] ? { format: w[S] } : w[S], F = document.createElement("li"), D = document.createElement("a"), E = document.createElement("img"), I = document.createElement("span"), P = ((M.action ? M.action : M.format) + "").toLowerCase();
        if (M.format = (M.format + "").toUpperCase(), F.addEventListener("mouseleave", function () { this.classList.remove("active"); }), D.addEventListener("focus", function () { if (!d.setup.hasTouch) {
    ...
    return; return d.construct(), d.deepMerge(this, d); }; }(), AmCharts.addInitHandler(function (t) { new AmCharts["export"](t); }, ["pie", "serial", "xy", "funnel", "radar", "gauge", "stock", "map", "gantt"]);
