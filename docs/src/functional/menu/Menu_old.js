...
var Menu_old = /** @class */ (function (_super) {
    __extends(Menu_old, _super);
    function Menu_old(props) {
    ...
    Menu_old.prototype.render = function () {
        var menu = this.getMenu(this.props.data);
        return menu;
    };
    Menu_old.prototype.getMenu = function (arr) {
        var me = this;
        var menu = [];
    ...
    Menu_old.prototype.getMenuItem = function (item, key) {
        var _this = this;
    ...
    Menu_old.prototype.setActiveItem = function (item) {
...
var CollapseMenu = /** @class */ (function (_super) {
    ...
    CollapseMenu.prototype.render = function () {
        ...
        return React.createElement(reactstrap_1.NavItem, { className: (this.state.collapse ? "opened" : "") },
            (item.catTitle !== undefined ? React.createElement("h4", { className: "catTitle" }, item.catTitle) : ""),
...
//# sourceMappingURL=Menu_old.js.map