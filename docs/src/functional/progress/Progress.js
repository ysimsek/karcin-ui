...
var Progress = /** @class */ (function (_super) {
    ...
    Progress.prototype.render = function () {
        ...
        if (this.props.multi) {
            ...
            component =
                React.createElement(reactstrap_1.Progress, { key: "p" + Math.floor(Math.random() * 10000), striped: this.props.striped ? true : false, animated: this.props.animated ? true : false, bar: this.props.bar ? true : false, color: this.props.color, value: this.props.value }, this.props.children);
        }
