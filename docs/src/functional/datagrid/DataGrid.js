        ...
        return React.createElement("div", { className: "karcin-data-grid", id: 'karcinDataGrid' + this.dataGridId },
            ...
            React.createElement("div", { className: "data-grid-body" },
                React.createElement("table", { className: "table table-bordered dataGrid" },
                    ...
                    React.createElement(TableBody_1.default, { onSelected: this.props.onSelected, store: this.state.store, cellRenderer: this.props.cellRenderer, rowRenderer: this.props.rowRenderer, fields: this.state.fields }))));
    };
    return DataGrid;
}(React.Component));
