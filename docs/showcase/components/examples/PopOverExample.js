...
var PopOverExample = /** @class */ (function (_super) {
    ...
    PopOverExample.prototype.render = function () {
        return React.createElement("div", null,
            React.createElement("span", { className: "example-reagent" }, "Button PopOver Example"),
            React.createElement(karcin_ui_1.Button, { color: "primary", id: "pop1", onClick: this.toggle.bind(this) }, "Click to Me"),
            ...
            React.createElement("span", { className: "example-reagent" }, "Span PopOver Example"),
