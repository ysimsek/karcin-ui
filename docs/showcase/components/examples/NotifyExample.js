        ...
        return React.createElement("div", null,
            React.createElement(reactstrap_1.Row, null,
                React.createElement(reactstrap_1.Col, { md: 4 },
                    React.createElement(karcin_ui_1.SelectInput, { name: "position", label: "Notify pozisyonunun seçiniz", item: this.state.position, value: "value", id: "position", items: items, onChange: this.selectOnChange.bind(this) })),
                React.createElement(reactstrap_1.Col, { md: 4 },
