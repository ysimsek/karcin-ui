...
var NotifyExample = /** @class */ (function (_super) {
        ...
        return (React.createElement("div", null,
            React.createElement(reactstrap_1.Row, null,
                React.createElement(reactstrap_1.Col, { md: 4 },
                    React.createElement(karcin_ui_1.SelectInput, { name: "position", label: "Notify pozisyonunu seçiniz", value: "value", id: "position", items: items, onChange: this.selectOnChange.bind(this) })),
                React.createElement(reactstrap_1.Col, { md: 4 },
            ...
            React.createElement("div", null,
                React.createElement("div", { className: "form" },
                    ...
                    ' ',
                    React.createElement(karcin_ui_1.Button, { color: "dark", outline: true, onClick: this.successDefault.bind(this) }, "Default Message"),
                    ' ')),
            React.createElement("hr", null)));
    };
    ...
    NotifyExample.prototype.successDefault = function (e) {
        karcin_ui_1.Notify.success("Only just message : " + this.state.message);
    };
