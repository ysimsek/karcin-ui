...
var ProgressExample = /** @class */ (function (_super) {
    ...
    ProgressExample.prototype.render = function () {
        return React.createElement("div", null,
            ...
            React.createElement("br", null),
            React.createElement("br", null),
            React.createElement(karcin_ui_1.Progress, { title: "39 of 135", value: 39, max: 135 }),
            React.createElement("br", null),
            React.createElement("br", null),
            React.createElement(karcin_ui_1.Progress, { multi: true, title: "Max value 80" },
                React.createElement(karcin_ui_1.Progress, { bar: true, color: "success", value: 25, max: 80 }, "25"),
                React.createElement(karcin_ui_1.Progress, { bar: true, color: "danger", value: 25, max: 80 }, "25"),
                React.createElement(karcin_ui_1.Progress, { bar: true, color: "info", value: 25, max: 80 }, "25")));
    };
