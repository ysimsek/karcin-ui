        ...
        return (React.createElement("div", { className: "example-menu" },
            React.createElement(reactstrap_1.Row, { className: "basic-row" },
                React.createElement(reactstrap_1.Col, { sm: 6 },
                    ...
                    React.createElement(karcin_ui_1.Menu, { data: data, accordion: true, active: this.state.active, onChange: function (val) { _this.handleChange(val); } })),
                React.createElement(reactstrap_1.Col, { sm: 6 },
                    React.createElement("span", { className: "example-reagent first" }, "Collapse Menu"),
                    React.createElement(karcin_ui_1.Menu, { data: data, active: this.state.active, renderer: this.renderer, onChange: function (val) { _this.handleChange(val); } })),
                React.createElement(reactstrap_1.Col, { sm: 6 },
                    React.createElement("span", { className: "example-reagent" }, "Hover Menu"),
                    React.createElement(karcin_ui_1.Menu, { data: data, hover: true, renderer: this.renderer, onChange: function (val) { _this.handleChange(val); } })))));
    };
    MenuExample.prototype.renderer = function (value) {
