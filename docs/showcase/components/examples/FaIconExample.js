...
var FaIconExample = /** @class */ (function (_super) {
    ...
    FaIconExample.prototype.getFaIconList = function (iconList) {
        ...
        iconList.fields.map(function (icon, idx) {
            component.push(React.createElement(karcin_ui_1.FaIcon, { code: icon, key: idx + icon, onClick: _this.onClick.bind(_this) }));
        });
        component.push(React.createElement("hr", null));
        iconList.fields2.map(function (icon, idx) {
            component.push(React.createElement(karcin_ui_1.FaIcon, { id: icon, code: icon, key: idx + icon, onClick: _this.onClick.bind(_this) }));
        });
        return component;
    };
