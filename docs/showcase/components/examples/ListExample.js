        ...
        return React.createElement(reactstrap_1.Row, null,
            ...
            React.createElement(reactstrap_1.Col, { md: 4 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple Child List" },
                    React.createElement(karcin_ui_1.List, null,
                        React.createElement(karcin_ui_1.ListItem, { color: "primary" }, "Lorem"),
                        React.createElement(karcin_ui_1.ListItem, { color: "success" }, "Ipsum"),
                        React.createElement(karcin_ui_1.ListItem, { color: "warning" }, "is simply"),
            ...
            React.createElement(reactstrap_1.Col, { md: 4 },
                React.createElement(karcin_ui_1.Panel, { title: "Active Link" },
                    React.createElement(karcin_ui_1.List, { data: data, value: "value", active: true, activeValue: "id", activeId: 4, onClick: this.Click.bind(this) }))));
    };
    ListExample.prototype.Click = function (e) {
        console.log(e);
    };
    return ListExample;
}(React.Component));
