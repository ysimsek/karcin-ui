        ...
        return React.createElement(reactstrap_1.Row, null,
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple Light Theme Chart" },
                    React.createElement(karcin_ui_1.BarChart, { data: data, theme: "light", textColor: "#000000", categoryField: "country", categoryValue: "visits", report: true, reportName: "SimpleChartReport_" }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
            ...
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple Pattern Theme Chart Scrolling" },
                    React.createElement(karcin_ui_1.BarChart, { data: data, theme: "black", scroll: true, textColor: "#3333aa", categoryField: "country", categoryValue: "visits", valueLine: true }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
