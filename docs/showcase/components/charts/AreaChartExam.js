        ...
        return React.createElement(reactstrap_1.Row, null,
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple AreaChart(none theme)" },
                    React.createElement(karcin_ui_1.AreaChart, { data: data, categoryValue: "value", categoryField: "date", formatting: "date", report: true }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple AreaChart(light theme)" },
                    React.createElement(karcin_ui_1.AreaChart, { theme: "light", data: data, textColor: "#aabbcc", categoryValue: "value", categoryField: "date", formatting: "date", report: true, menu: [
                            {
                                label: "İndir",
                                type: "download",
                                child: [
                                    ...
                                    { label: "Jpg İndir", type: "jpg", callBack: function (res) { console.log(res); } },
                                    { label: "Xlsx İndir", type: "xlsx", callBack: function (res) { console.log(res); } },
                                    { label: "Verileri Göster", callBack: function (res) { console.log(res); } },
                                ]
                            }
                        ] }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
