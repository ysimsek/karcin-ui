        ...
        return React.createElement(reactstrap_1.Row, null,
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple AreaChart(none theme)" },
                    React.createElement(karcin_ui_1.AreaChart, { data: data, categoryValue: "value", categoryField: "date" }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple AreaChart(light theme)" },
                    React.createElement(karcin_ui_1.AreaChart, { theme: "light", data: data, textColor: "#aabbcc", categoryValue: "value", categoryField: "date" }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple AreaChart(dark theme)" },
                    React.createElement(karcin_ui_1.AreaChart, { theme: "dark", data: data, textColor: "red", categoryValue: "value", categoryField: "date" }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple AreaChart Changes values" },
                    React.createElement(karcin_ui_1.AreaChart, { data: data, categoryValue: "value", categoryField: "date", cutOffColor: "lineColor" }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Horizantal Area Chart" },
                    React.createElement(karcin_ui_1.AreaChart, { data: data, inline: true, categoryValue: "value", categoryField: "date", cutOffColor: "lineColor" }))));
    };
