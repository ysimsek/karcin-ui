        ...
        return React.createElement(reactstrap_1.Row, null,
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Simple LineChart" },
                    React.createElement(karcin_ui_1.LineChart, { data: data, theme: "none", categoryField: "date", categoryValue: "value" }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Light LineChart" },
                    React.createElement(karcin_ui_1.LineChart, { data: data, theme: "light", textColor: "red", categoryField: "date", categoryValue: "value" }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Pattern LineChart" },
                    React.createElement(karcin_ui_1.LineChart, { data: data, theme: "patterns", textColor: "blue", categoryField: "date", categoryValue: "value" }))),
            React.createElement(reactstrap_1.Col, { md: 6 },
                React.createElement(karcin_ui_1.Panel, { title: "Negative/Positive LineChart" },
                    React.createElement(karcin_ui_1.LineChart, { data: data, negativeColor: "red", positiveColor: "blue", categoryField: "date", categoryValue: "value" }))));
    };
