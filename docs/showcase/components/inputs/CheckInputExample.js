...
var CheckInputExample = /** @class */ (function (_super) {
    ...
    CheckInputExample.prototype.render = function () {
        return React.createElement("div", null,
            React.createElement(karcin_ui_1.CheckInput, { items: this.data, label: "Simple CheckInput Example", name: "data", id: "id", valid: true, value: "name", onChange: this.handleChange.bind(this) }),
