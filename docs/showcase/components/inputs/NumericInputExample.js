...
var NumericInputExample = /** @class */ (function (_super) {
    ...
    NumericInputExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(karcin_ui_1.NumericInput, { name: "numericInput", value: this.state.numericInput, label: "NumericInput Example", valid: true, onChange: this.handleChange.bind(this) }),
