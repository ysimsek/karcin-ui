...
var PasswordInputExample = /** @class */ (function (_super) {
    ...
    PasswordInputExample.prototype.render = function () {
        return React.createElement("div", null,
            React.createElement(karcin_ui_1.PasswordInput, { name: "passwordInput", label: "PasswordInput Example", value: this.state.passwordInput, valid: true, onChange: this.handleChange.bind(this) }),
