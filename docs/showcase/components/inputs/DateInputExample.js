        ...
        return (React.createElement(reactstrap_1.Row, null,
            React.createElement(reactstrap_1.Col, { xs: 4 },
                ...
                React.createElement("div", null,
                    React.createElement(react_datepicker_1.default, { selected: this.state.startDate1, onChange: function (e) { _this.handleChange(e, 1); }, onYearChange: this.handleYearChange, className: "form-control" }))),
            React.createElement(reactstrap_1.Col, { xs: 4 },
                React.createElement(reactstrap_1.Label, { style: { fontWeight: 'bold' } }, "Inline DatePicker"),
                React.createElement("div", null,
                    React.createElement(react_datepicker_1.default, { inline: true, selected: this.state.startDate2, onChange: function (e) { _this.handleChange(e, 2); }, onYearChange: this.handleYearChange }))),
            React.createElement(reactstrap_1.Col, null,
                React.createElement(reactstrap_1.Label, { style: { fontWeight: 'bold' } }, "Time DatePicker"),
                React.createElement("div", null,
                    React.createElement(react_datepicker_1.default, { selected: this.state.startDate3, onChange: function (e) { _this.handleChange(e, 3); }, showTimeSelect: true, timeFormat: "HH:mm", timeIntervals: 15, dateFormat: "LLL", className: "form-control" })))));
    };
