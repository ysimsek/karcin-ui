    ...
    HomePage.prototype.render = function () {
        ...
        if (sessionStorage.getItem("date")) {
            ...
            date = React.createElement("span", null,
                karcin_ui_1.I18n.message("home.buildDate"),
                ": ",
            ...
            React.createElement("div", { className: "header" },
                ...
                React.createElement(reactstrap_1.Container, { className: "slide-title" },
                    React.createElement("h3", null,
                        "Kar\u00E7in UI ",
                        karcin_ui_1.I18n.message("home.message")),
                    ...
                    React.createElement("div", { className: "buttons" },
                        React.createElement(karcin_ui_1.Button, { onClick: this.getStarted, color: "primary", size: "lg" }, karcin_ui_1.I18n.message("home.started")),
                        ' ',
                        React.createElement(karcin_ui_1.Button, { href: "#Components", color: "success", size: "lg" }, karcin_ui_1.I18n.message("title.component"))))),
            React.createElement("div", { id: "get-started" },
                React.createElement(reactstrap_1.Container, null,
                    React.createElement(reactstrap_1.Row, null,
                        React.createElement(reactstrap_1.Col, null,
                            React.createElement("h2", null, karcin_ui_1.I18n.message("home.started")),
                            React.createElement("hr", null),
                            React.createElement("h4", null, "NPM"),
                            React.createElement("p", null, karcin_ui_1.I18n.message("home.npm")),
                            ...
                            React.createElement("p", null, karcin_ui_1.I18n.message("or")),
                            React.createElement("pre", null,
                                React.createElement("code", { className: "hljs" },
                                    React.createElement("span", { className: "hljs-keyword" }, "yarn"),
                                    " add ",
                                    React.createElement("span", { className: "hljs-string" }, "karcin-ui"))),
                            React.createElement("p", null, karcin_ui_1.I18n.message("home.npm2")),
                            React.createElement("div", { className: "example-card" },
                                React.createElement("p", null, karcin_ui_1.I18n.message("example")),
