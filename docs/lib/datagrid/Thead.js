...
var Thead = /** @class */ (function (_super) {
    ...
    Thead.prototype.getItemControl = function () {
        ...
        return React.createElement("thead", null, (headItemGroup.length > 0 ? React.createElement("tr", null, headItemGroup) : ''), React.createElement("tr", null, headItem));
    };
        ...
        if (data !== undefined) {
            ...
            if (Array.isArray(data)) {
                data.forEach(function (value, indexes) {
                    ...
                    returnItem.push(React.createElement("th", { key: indexes, className: "" + (_this.state.orderIng.name !== null && value.name === _this.state.orderIng.name || _this.state.filterShowing[value.name] ? 'active' : ''), style: style, ref: function (e) { return itemRef_1 = e; } }, value.label, React.createElement("div", { className: "right-option" }, (value.filter === undefined || value.filter ? _this.getFilter(value) : ''), _this.orderIcon(value)), _this.dropDownMenu(value), React.createElement("span", { className: "resizing", onMouseDown: function (e) { _this.resizing(value, itemRef_1, index); }, onMouseUp: function (e) { _this.removeResizing(value, itemRef_1); } })));
                });
            }
            else {
                var style = {};
                ...
                returnItem.push(React.createElement("th", { key: index, style: style, className: "" + (this.state.orderIng.name !== null && data.name === this.state.orderIng.name ? 'active' : ''), ref: function (e) { return itemRef_1 = e; } }, data.label, React.createElement("div", { className: "right-option" }, (data.filter === undefined || data.filter ? this.getFilter(data) : ''), this.orderIcon(data)), this.dropDownMenu(data), React.createElement("span", { className: "resizing", onMouseDown: function (e) { _this.resizing(data, itemRef_1, index); }, onMouseUp: function (e) { _this.removeResizing(data, itemRef_1); } })));
            }
        }
        return returnItem;
    };
            ...
            this.state.fields.forEach(function (value, index) {
                if (value['visibility'] !== undefined && !value['visibility']) {
                    fieldButtons.push(React.createElement(reactstrap_1.DropdownItem, { onClick: function () {
                        ...
                        } }, React.createElement(reactstrap_1.Input, { type: "checkbox", defaultChecked: false }), value.label));
                }
                else {
                    fieldButtons.push(React.createElement(reactstrap_1.DropdownItem, { onClick: function () {
                            _this.fieldShowing(index);
                        } }, React.createElement(reactstrap_1.Input, { type: "checkbox", defaultChecked: true }), value.label));
                }
            });
        }
        return (this.state.fieldOption !== undefined && this.state.fieldOption ? React.createElement(reactstrap_1.ButtonDropdown, { isOpen: this.state.dropDownMenu[value.name], toggle: function () { _this.toggleDropdown(value.name); } }, React.createElement(reactstrap_1.DropdownToggle, { caret: true }), React.createElement(reactstrap_1.DropdownMenu, null, (value.order === undefined || value.order ? React.createElement(reactstrap_1.DropdownItem, { onClick: function () {
                _this.orderIng(value, 'asc');
            } }, React.createElement(FaIcon_1.default, { code: "fa-arrow-down" }), " S\u0131rala") : ''), (value.order === undefined || value.order ? React.createElement(reactstrap_1.DropdownItem, { onClick: function () {
                _this.orderIng(value, 'desc');
            } }, React.createElement(FaIcon_1.default, { code: "fa-arrow-up" }), " S\u0131rala") : ''), (value.order === undefined || value.order ? React.createElement(reactstrap_1.DropdownItem, { divider: true }) : ''), fieldButtons)) : '');
    };
    ...
    Thead.prototype.orderIcon = function (value) {
        ...
        if (this.state.orderIng.name !== null && value.name === this.state.orderIng.name) {
            ...
            returnIcon = React.createElement("span", { className: 'order-icon' }, React.createElement(FaIcon_1.default, { code: returnIcon }));
        }
        return returnIcon;
    };
    Thead.prototype.getFilter = function (data) {
        var _this = this;
        var filterContent;
        filterContent = React.createElement(reactstrap_1.ButtonDropdown, { isOpen: (this.state.filterShowing[data.name] !== undefined && this.state.filterShowing[data.name]) ? this.state.filterShowing[data.name] : false, toggle: function () { _this.filterToggle(data); } }, React.createElement(reactstrap_1.DropdownToggle, null, React.createElement(FaIcon_1.default, { code: "fa-filter" })), React.createElement(reactstrap_1.DropdownMenu, null, React.createElement(GetInput_1.default, { type: data.type, value: this.state.filterOption.value, onChange: function (e) {
                _this.filterData(data.name, e);
            } }), React.createElement(reactstrap_1.Button, null, React.createElement(FaIcon_1.default, { code: "fa-search" }))));
