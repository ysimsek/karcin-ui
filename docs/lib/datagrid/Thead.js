    ...
    Thead.prototype.getItems = function (data, index) {
        ...
        if (data !== undefined) {
            ...
            if (Array.isArray(data)) {
                ...
                returnItem.push(React.createElement("th", { key: index, style: style, className: "" + (this.state.orderIng.name !== null && data.name === this.state.orderIng.name ? 'active' : ''), ref: function (e) { return itemRef_1 = e; } }, React.createElement("div", { className: "th-title" }, data.label), React.createElement("div", { className: "right-option" }, (data.filter === undefined || data.filter ? this.getFilter(data) : ''), this.orderIcon(data)), this.dropDownMenu(data), React.createElement("span", { className: "resizing", onMouseDown: function (e) { _this.resizing(data, itemRef_1, index); }, onMouseUp: function (e) { _this.removeResizing(data, itemRef_1); } })));
            }
        }
        return returnItem;
    };
            ...
            this.state.fields.forEach(function (values, index) {
                if (values['visibility'] !== undefined && !values['visibility']) {
                    fieldButtons.push(React.createElement(reactstrap_1.DropdownItem, { onClick: function () {
                        ...
                        } }, React.createElement(reactstrap_1.Input, { type: "checkbox", defaultChecked: false }), values.label));
                }
                else {
                    fieldButtons.push(React.createElement(reactstrap_1.DropdownItem, { onClick: function () {
                            _this.fieldShowing(index);
                        } }, React.createElement(reactstrap_1.Input, { type: "checkbox", defaultChecked: true }), values.label));
                }
            });
        }
        return (this.state.fieldOption !== undefined && this.state.fieldOption ? React.createElement(reactstrap_1.ButtonDropdown, { isOpen: this.state.dropDownMenu[value.name], toggle: function () { _this.toggleDropdown(value.name); } }, React.createElement(reactstrap_1.DropdownToggle, { caret: true }), React.createElement(reactstrap_1.DropdownMenu, { right: true }, (value.order === undefined || value.order ? React.createElement(reactstrap_1.DropdownItem, { onClick: function () {
