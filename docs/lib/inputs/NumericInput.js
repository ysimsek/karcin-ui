...
var NumericInput = /** @class */ (function (_super) {
    ...
    NumericInput.prototype.render = function () {
        ...
        return React.createElement("div", { className: "karcin-input" }, label, React.createElement(BaseInput_1.default, __assign({}, newProps, { onChange: this.__onChange.bind(this) })));
    };
    /**
     * number control
     * @param e
