...
var CheckInput = /** @class */ (function (_super) {
    ...
    CheckInput.prototype.render = function () {
        ...
        return React.createElement("div", { className: "karcin-input" }, this.props.label != undefined ? React.createElement("b", null, this.props.label) : "", React.createElement("div", { className: "list-group-item form-group", style: { borderColor: validColor } }, me.props.items != undefined ? this.returnItems() : this.returnItem(), this.isChecked = true));
    };
    CheckInput.prototype.returnItems = function () {
        var _this = this;
        var me = this;
        return me.props.items.length > 0 ?
            me.props.items.map(function (value, i) {
                return (React.createElement("div", { key: i }, React.createElement("label", { className: "check-container" }, _this.props.onRenderer != undefined ? _this.props.onRenderer(value) : value[me.props.value], _this.childInputElements(value), React.createElement("span", { className: "checkmark" }))));
            }) : React.createElement("div", { key: -1 }, React.createElement("label", { className: "check-container" }, this.childInputElements(null), React.createElement("span", { className: "checkmark" })));
    };
    CheckInput.prototype.returnItem = function () {
        var me = this;
        return React.createElement("div", { key: this.props.key }, React.createElement("label", { className: "check-container" }, me.props.onRenderer != undefined ? me.props.onRenderer(me.props.item) : me.props.item[me.props.value], this.childInputElements(me.props.item), React.createElement("span", { className: "checkmark" })));
    };
    /**
