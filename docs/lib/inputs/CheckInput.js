...
var CheckInput = /** @class */ (function (_super) {
    ...
    CheckInput.prototype.render = function () {
        var me = this;
        return React.createElement("div", { className: "karcin-input" }, this.props.label != undefined ? React.createElement("b", null, this.props.label) : "", React.createElement("div", { className: "list-group-item form-group" }, me.props.items != undefined ? this.returnItems() : this.returnItem(), this.isChecked = true));
    };
