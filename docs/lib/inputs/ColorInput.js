...
var ColorInput = /** @class */ (function (_super) {
    ...
    ColorInput.prototype.render = function () {
        ...
        return React.createElement("div", { className: "karcin-input" }, label, React.createElement(BaseInput_1.default, __assign({}, this.props, { onChange: this.___onChange.bind(this) })));
    };
