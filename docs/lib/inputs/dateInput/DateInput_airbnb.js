...
var DateInput = /** @class */ (function (_super) {
    ...
    DateInput.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'karcin-dateInput' }, React.createElement("div", { className: "form-group" }, (this.props.label !== undefined) ? React.createElement("label", { className: 'label-properties' }, this.props.label) : '', React.createElement(react_dates_1.SingleDatePicker, { id: this.props.id, date: this.state.value, onDateChange: function (e) {
