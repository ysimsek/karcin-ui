...
var DateInput = /** @class */ (function (_super) {
    ...
    DateInput.prototype.render = function () {
        ...
        return (React.createElement("div", null, this.props.label != undefined ? React.createElement(reactstrap_1.Label, { className: "label-properties" }, this.props.label) : null, React.createElement("div", null, React.createElement(react_datepicker_1.default, __assign({}, this.props, { selected: startDate, onChange: function (e, id) { _this.handleChange(e, id); }, className: "form-control " + this.props.className, inline: this.props.inline != undefined ? true : false, shouldCloseOnSelect: true })))));
    };
