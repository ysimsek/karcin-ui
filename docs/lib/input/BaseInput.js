...
var InputGroup_1 = require("reactstrap/lib/InputGroup");
var BaseInput = /** @class */ (function (_super) {
    ...
    BaseInput.prototype.render = function () {
        var getInput = this.returnInput();
        var returnInput = getInput;
        if (this.props.inputAddon !== undefined) {
            returnInput = React.createElement(InputGroup_1.default, null, getInput, React.createElement(reactstrap_1.InputGroupAddon, { addonType: this.props.inputAddonType }, this.props.inputAddon));
        }
        return React.createElement(reactstrap_1.FormGroup, { tag: this.props.tag }, React.createElement(reactstrap_1.Label, { for: this.props.id }, React.createElement("b", null, this.props.label)), returnInput);
    };
    /**
    ...
    BaseInput.prototype.returnRadioInput = function (type) {
        ...
        values.forEach(function (v) {
            if (isChecked == v.value) {
                ...
                isChecked = false;
            component.push(React.createElement(reactstrap_1.FormGroup, { check: true, disabled: v.disabled, className: className }, React.createElement(reactstrap_1.Label, { check: true }, React.createElement(reactstrap_1.Input, { key: v.id, type: type, name: me.props.name, value: v.id }), ' ', v.value)));
        });
    ...
    BaseInput.prototype.returnCheckInput = function (type) {
        ...
        var me = this;
        values.forEach(function (v) {
            component.push(React.createElement(reactstrap_1.Form, { onChange: me.onChange.bind(me) }, React.createElement(reactstrap_1.FormGroup, { check: true }, React.createElement(reactstrap_1.Label, { check: true }, React.createElement(reactstrap_1.Input, { type: type, value: v.value }), v.value))));
        });
        return component;
    };
