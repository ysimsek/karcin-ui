...
var ContextMenu = /** @class */ (function (_super) {
    ...
    ContextMenu.prototype.render = function () {
        return React.createElement("div", { className: "karcin-context-menu " + ((this.state.showContext.control) ? 'active' : ''), style: { top: this.state.eventDirection.y, left: this.state.eventDirection.x } }, React.createElement(reactstrap_1.Dropdown, { toggle: function () {
        ...
        if (this.props.data !== undefined) {
            getData.forEach(function (value, index) {
                listMenu.push(React.createElement("div", { className: "dropdown-item", key: index, onClick: function () {
                    ...
                    } }, React.createElement("div", { className: "menu-head" }, React.createElement(reactstrap_1.NavLink, { href: value.link, target: "_blank" }, value.icon !== undefined ? React.createElement(FaIcon_1.default, { code: value.icon, className: "basic-icon" }) : '', React.createElement("span", null, value.title), (value.items) ? React.createElement(FaIcon_1.default, { code: "fa-angle-right dropdown-icon" }) : '')), value.items !== undefined && value.items.length > 0 ?
