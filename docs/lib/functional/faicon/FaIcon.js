...
var FaIcon = /** @class */ (function (_super) {
    ...
    FaIcon.prototype.render = function () {
        ...
        return this.props.code != undefined ? (this.props.code.split("-").length >= 2 ?
            React.createElement("i", __assign({}, props, { id: this.props.id, className: className + " " + color, "aria-hidden": "true", onClick: this.onClick.bind(this) }))
            : React.createElement("span", { onClick: this.onClick.bind(this) }, React.createElement(react_fontawesome_1.FontAwesomeIcon, __assign({ className: color }, props, { size: this.getSizeProp(this.props.size), spin: this.props.spin, icon: iconS[this.props.code] })))) : null;
    };
