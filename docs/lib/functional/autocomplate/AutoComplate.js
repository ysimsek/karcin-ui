...
var AutoComplate = /** @class */ (function (_super) {
    ...
    AutoComplate.prototype.render = function () {
        var _this = this;
        return React.createElement("div", { className: "karcin-select-input select-" + this.state.randomId, onClick: function () {
                if (_this.props.type !== "single") {
                    _this.inputFocus();
                }
            } }, React.createElement("div", { className: "form-group " + this.props.labelPosition }, this.labelResult(), React.createElement("div", { className: "select-input-result" }, this.multiSelectResult(), (this.state.showing.multiDrop && this.props.items.length > 0) ? this.getDropDownItems() : '')));
    };
    /**
    ...
    AutoComplate.prototype.multiSelectResult = function () {
        var _this = this;
        var returnHtml = React.createElement("div", { className: "multi-select-input " + ((this.state.focusControl.control) ? 'input-focus' : '') }, React.createElement("input", { type: "text", placeholder: (this.state.selectedItem.length <= 0 ? this.props.placeholder !== false ? this.props.placeholder : '' : ''), value: this.state.inputText.value, onKeyDown: function (event) {
