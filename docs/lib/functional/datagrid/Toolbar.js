...
var Toolbar = /** @class */ (function (_super) {
    ...
    function Toolbar(props) {
        ...
        _this.modalHtml = function () {
            ...
            var modalHtml = React.createElement(reactstrap_1.Modal, { isOpen: _this.state.isOpen, toggle: _this.toggleModal }, React.createElement(reactstrap_1.ModalHeader, { toggle: _this.toggleModal }, "DataGrid \u0130\u015Flemleri"), React.createElement(reactstrap_1.ModalBody, null, React.createElement("div", null, React.createElement(DataForm_1.default, { nameText: _this.props.dataFormNameText, labelText: _this.props.dataFormLabelText, fields: newField, ref: function (e) {
                    _this.dataForm = e;
                }, values: _this.editValues, col: 1 }))), React.createElement(reactstrap_1.ModalFooter, null, (_this.state.buttonType === 'create') ? React.createElement(reactstrap_1.Button, { color: "primary", onClick: _this.openSave }, "Kaydet") : '', (_this.state.buttonType === 'update') ? React.createElement(reactstrap_1.Button, { color: "success", onClick: _this.openEdit }, "D\u00FCzenle") : '', React.createElement(reactstrap_1.Button, { color: "secondary", onClick: _this.toggleModal }, "Kapat")));
            return modalHtml;
        };
            ...
            if (data !== undefined) {
                var _loop_1 = function (i) {
                    ...
                    buttons.push(React.createElement(reactstrap_1.Button, { key: i, color: "defaults", disabled: (value.disabled !== undefined ? value.disabled : false), onClick: function () {
                        ...
                        React.createElement(FaIcon_1.default, { code: value.icon }) : ""), React.createElement("span", null, value.name)));
                };
                for (var i = 0; i < data.length; i++) {
                    _loop_1(i);
                }
            }
            returnHtml = React.createElement("div", { className: "data-grid-header" }, React.createElement(reactstrap_1.Row, null, this.props.title !== undefined ? React.createElement(reactstrap_1.Col, { className: 'datagridTitle' }, this.props.title) : '', React.createElement(reactstrap_1.Col, { xs: { size: 4, offset: 8 }, className: "header-buttons" }, React.createElement(reactstrap_1.ButtonGroup, null, buttons))), this.modalHtml());
        }
        else {
            // footer Html Elements
            returnHtml = React.createElement("div", { className: "data-grid-footer" }, React.createElement(reactstrap_1.Row, null, (this.props['pageShow'] !== undefined && this.props.store !== undefined && this.props.store.props.totalCount > 0) ?
                React.createElement(reactstrap_1.Col, { className: "pagination-main" }, React.createElement("div", { className: "pagination" }, React.createElement(Pagination_1.default, { pageCount: 5, type: "simple", typeShowLength: this.props['pageShow'], data: this.props.store.props.totalCount, selectedValue: function (e) {
