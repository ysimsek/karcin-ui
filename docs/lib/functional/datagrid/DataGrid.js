...
var DataGrid = /** @class */ (function (_super) {
    ...
    DataGrid.prototype.dataGridLoadComponent = function () {
        ...
        this.returnComponent = React.createElement("div", null, React.createElement(Toolbar_1.default, __assign({ data: this.props.toolbar, store: this.props.store, type: "header", selectedRow: this._selectedRow, dataFormLabelText: this.props.dataFormLabelText, dataFormNameText: this.props.dataFormNameText }, this.props)), React.createElement("div", { className: "data-grid-body" }, React.createElement("table", { className: "table table-bordered dataGrid" }, React.createElement(TableHead_1.default, __assign({ fields: this.state.fields, fieldOption: this.fieldOption, store: this.props.store, resetData: function () {
                _this.resetData();
            } }, this.props)), React.createElement(Loading_1.default, { show: false, size: 'inset' }), React.createElement(TableBody_1.default, { ref: function (ref) { _this.tbodyRef = ref; }, onSelected: (this.props.onSelected !== false ? function (data, select) {
                _this._selectedRow = data;
                if (_this.props.onSelected !== undefined) {
                    _this.props.onSelected(data, select);
                }
            } : this.props.onSelected), onDoubleClick: this.onDoubleClick.bind(this), fieldOption: this.fieldOption, store: this.props.store, cellRenderer: this.props.cellRenderer, rowRenderer: this.props.rowRenderer, fields: this.state.fields, showingPageData: this.state.pageShowData, multiSelect: this.props.multiSelect }))), React.createElement(Toolbar_1.default, __assign({ store: this.props.store }, this.props, { changePage: function (e) {
                _this.pageChange(e);
            } })));
