...
var GetInput_1 = require("../getInput/GetInput");
var TableHead = /** @class */ (function (_super) {
    ...
    TableHead.prototype.render = function () {
        return React.createElement("thead", null, React.createElement("tr", null, this.returnItems()));
    };
    TableHead.prototype.returnItems = function () {
        ...
        var _loop_1 = function (i) {
            ...
            Cell.push(React.createElement("th", { key: i, className: cellClass, style: style }, React.createElement("span", { onClick: function () {
                    _this.orderData(value.value);
                } }, value.label), React.createElement("div", { className: "title-option" }, (this_1.props.filter === true ? React.createElement("span", { className: "filter", id: 'Popover' + i, onClick: function () {
                    self.popoverOpen(i);
                } }, React.createElement(FaIcon_1.default, { code: "fa-filter" })) : ''), (this_1.props.filter === true ? React.createElement(reactstrap_1.Popover, { placement: "bottom", isOpen: self.state.popover[i], target: "Popover" + i, toggle: function () {
                    self.popoverOpen(i);
                }, className: "popup-over-search" }, React.createElement(reactstrap_1.PopoverHeader, null, "Ad\u0131"), React.createElement(reactstrap_1.PopoverBody, null, React.createElement(reactstrap_1.InputGroup, null, React.createElement(GetInput_1.default, { type: value.type, value: this_1.state.filterOption.value, onChange: function (e) {
                    _this.filterData(value.value, e);
                } }), React.createElement(reactstrap_1.InputGroupAddon, { addonType: "append" }, React.createElement(reactstrap_1.Button, null, React.createElement(FaIcon_1.default, { code: "fa-search" })))))) : ''), (this_1.props.order === true ?
