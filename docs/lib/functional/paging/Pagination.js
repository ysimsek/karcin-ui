...
var Pagination = /** @class */ (function (_super) {
    ...
    Pagination.prototype.renderPageFunctions = function (data, type) {
        ...
        type == "normal" ?
            data.forEach(function (val, idx) {
                i++;
                component.push(React.createElement(reactstrap_1.PaginationItem, { active: parseInt(me.selectPage) == idx + 1 ? true : false, key: i }, React.createElement(reactstrap_1.PaginationLink, { id: i, href: val[me.props.hrefValue] }, idx + 1)));
            }) : (x = true);
        if (x == true) {
            for (var j = 0; j < parseInt(data) / me.props.typeShowLength; j++) {
                i++;
                component.push(React.createElement(reactstrap_1.PaginationItem, { active: parseInt(me.selectPage) == j + 1 ? true : false, key: j + 1 }, React.createElement(reactstrap_1.PaginationLink, { id: j + 1, key: j + 1 }, j + 1)));
            }
        }
    ...
    Pagination.prototype.firstPageElement = function () {
        return React.createElement("li", { key: -1, className: "page-item" + (this.selectPage == 1 ? " disabled" : "") }, React.createElement("a", { id: "firstDecrease", className: "page-link", "aria-label": "Next" }, this.props.toBegin));
    };
    /**
    ...
    Pagination.prototype.lastPageElement = function () {
        return React.createElement("li", { key: -2, className: "page-item" + (this.lastIndex == this.selectPage ? " disabled" : "") }, React.createElement("a", { id: "lastIncrease", className: "page-link", "aria-label": "Next" }, this.props.toEnd));
    };
    /**
     * Son elemanda statik bir şekilde pushlanıyor
     */
    Pagination.prototype.increaseElement = function (i) {
        return React.createElement("li", { key: i + 2, className: "page-item" + (this.lastIndex == this.selectPage ? " disabled" : "") }, React.createElement("a", { id: "increase", className: "page-link", "aria-label": "Next" }, "\u203A"));
    };
    /**
     * İlk eleman azaltma elemanı ilk başta pushlanıyor
     */
    Pagination.prototype.decreaseElement = function (i) {
        return React.createElement("li", { key: i, className: "page-item" + (this.selectPage == 1 ? " disabled" : "") }, React.createElement("a", { id: "decrease", className: "page-link", "aria-label": "Previous" }, "\u2039"));
    };
    /**
     * Bla Bla element
    ...
    Pagination.prototype.blablaElement = function (i) {
        return React.createElement("li", { key: i, className: "page-item disabled" }, React.createElement("span", { id: "blabla", className: "page-link", "aria-label": "BlaBla" }, "\u2026"));
    };
    /**
