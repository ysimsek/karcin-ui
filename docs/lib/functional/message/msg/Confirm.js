...
var Confirm = /** @class */ (function (_super) {
    ...
    Confirm.prototype.getMessageElement = function () {
        ...
        return React.createElement("div", { className: "modal fade show-box left " + (this.state.show == true ? "show" : ""), style: this.state.show == true ? { display: "block" } : { display: "none" }, id: "exampleModalCenter", tabIndex: -1, role: "dialog", "aria-labelledby": "exampleModalCenterTitle", "aria-hidden": "true" }, React.createElement("div", { className: "modal-dialog modal-dialog-centered", role: "document" }, React.createElement("div", { className: "modal-content" }, React.createElement("div", { className: "modal-body" }, React.createElement("div", { className: "alert-option " + this.props.color }, React.createElement(index_1.FaIcon, { code: this.props.icon })), React.createElement("div", { className: "general-content" }, (this.props.title !== undefined) ? React.createElement("h3", null, this.props.title) : null, (this.props.message !== undefined) ? React.createElement("p", null, this.props.message) : null, React.createElement(index_1.Button, { onClick: this.tmm.bind(this), name: "OK", color: this.props.color, "data-dismiss": "modal" }, "Tamam"), ' ', React.createElement("button", { type: "button", onClick: this.ipt.bind(this), name: "CANCEL", className: "btn btn-outline-dark" }, "\u0130ptal"))))));
    };
